...
@section('container')
<div class="col-auto">
    <h1 class="app-page-title mb-0">Pesanan</h1>
</div>
<div class="col-10">
    <div class="page-utilities">
        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
            <div class="col-auto">
                <form action="/admin/transaction" method="GET" class="table-search-form row gx-1 align-items-center">
                    <div class="col-auto">						    
                        <select class="form-select w-auto" name="year">
                            @if (!request('year'))
                            <option value="year" selected disabled>Select Year</option>
                            @else 
                            <option value="year" disabled>Select Year</option>
                            @endif
                            @php
                                $year = date('Y');
                                $min = $year - 8;
                        ...
                        <tbody>
                            @foreach ($all as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="cell"><span class="badge {{ $item->pesanan == 'diproses' ? 'bg-secondary' : 'bg-success'}}">{{ $item->pesanan }}</span></td>
                                    <td class="cell">
                                        <td class="cell">    
                                            @if ($item->status == 'paid' && $item->pesanan == 'diproses')
                                    ...
                                    <td class="cell"><a class="btn-sm app-btn-secondary" href="/admin/chef/{{ $item->id }}">View</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
