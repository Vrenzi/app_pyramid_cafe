            ...
            <div class="row justify-content-around">
                                ...
                                <div class="row  justify-content-between mb-3 pe-2">
                                    <div class="col-auto col-md-7">
                                        <div class="media flex-column flex-sm-row">
                                            <img class=" img-fluid" src="{{ asset('storage/images/'.$item->menu->picture) }}" width="62" height="62">
                ...
                <div class="col-md-5">
                    <div class="card border-0">
                        ...
                        @else
                        <form action="{{ $key->id }}" method="POST" class="card-body">
                            @csrf
                            @method('put')
                            <input type="hidden" name="id" id="id_transaction" value="{{ $key->id }}">
                            <div class="form-group mb-3">
...
<script>
    ...
    function show_my_receipt1() {
        var page = '/admin/invoice/'+ document.getElementById('id_transaction').value;
