...
@section('container')
    ...
    <div class="col-md-4 h-100 p-0 d-flex flex-column">
        ...
        <div class="cart-body d-flex flex-column justify-content-between" style="height: 780px;">
            ...
            <form action="add" method="POST" class="align-self-center p-0 m-0" style="width: 90%;">
                @csrf
                ...
                <div class="cart-payment p-2 d-flex flex-column rounded">
                    ...
                    <div class="section-pay d-flex justify-content-between align-items-center p-2">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#table">Choose Table</button>
                    </div>
                </div>
                <button type="submit"
        ...
        <div class="modal-dialog modal-dialog modal-xl">
            <div class="modal-content shadow" style="background-color: #181818fd">
                <div class="modal-header" id="staticBackdropLabel">
                    <h1 class="modal-title fs-5 text-white" id="exampleModalLabel">Choose</h1>
                ...
                <div class="modal-body" style="background-image: url(/images/map-layout.png);">
                    <div class="row h-100">
                            ...
                            <div class="tables d-flex flex-column justify-content-between h-100">
                                ...
                                <div class="top d-flex justify-content-between align-items-end mt-4">
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" srcset="" data-table="not-selected" data-number="A1">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                            A1</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" srcset="" data-table="not-selected" data-number="A2">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        A2</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" srcset="" data-table="not-selected" data-number="A3">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        A3</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" srcset="" data-table="not-selected" data-number="A4">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        A4</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" srcset="" data-table="not-selected" data-number="A5">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        A5</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" srcset="" data-table="not-selected" data-number="A6">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        A6</p>
                                    </div>
                                </div>
                                <div class="midle d-flex justify-content-between align-items-end mt-4">
                                    <div class="tab-container position-relative">
                                        <img class="table-C1" src="/images/table/meja0.png" width="120"
                                            alt="" srcset="" data-table="not-selected" data-number="B1">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                            B1</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-C1" src="/images/table/meja0.png" width="120"
                                            alt="" srcset="" data-table="not-selected" data-number="B2">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        B2</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-C1" src="/images/table/meja0.png" width="120"
                                            alt="" srcset="" data-table="not-selected" data-number="B3">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        B3</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-C1" src="/images/table/meja0.png" width="120"
                                            alt="" srcset="" data-table="not-selected" data-number="B4">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        B4</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-C1" src="/images/table/meja0.png" width="120"
                                            alt="" srcset="" data-table="not-selected" data-number="B5">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        B5</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-C1" src="/images/table/meja0.png" width="120"
                                            alt="" srcset="" data-table="not-selected" data-number="B6">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        B6</p>
                                    </div>
                                </div>
                                ...
                                <div class="bottom d-flex justify-content-between">
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" data-table="not-selected" data-number="D1">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                            D1</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" data-table="not-selected" data-number="D2">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        D2</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" data-table="not-selected" data-number="D3">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        D3</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" data-table="not-selected" data-number="D4">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        D4</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" data-table="not-selected" data-number="D5">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        D5</p>
                                    </div>
                                    <div class="tab-container position-relative">
                                        <img class="table-B" src="/images/table/meja5.png" width="75"
                                            alt="" data-table="not-selected" data-number="Take Away">
                                        <p class="position-absolute top-50 start-50 translate-middle fw-bold text-tables">
                                        Take Away</p>
                                    </div>
                                </div>
