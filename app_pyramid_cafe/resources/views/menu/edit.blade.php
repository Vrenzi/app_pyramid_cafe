...
<form class="settings-form" action="/admin/menu/{{ $menu->id }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('put')
    <div class="row g-3 settings-section">
        ...
        <div class="col-12 col-md-4 picture-container" style="display: flex; flex-direction: column; justify-content: center;">
            <img src="{{ asset('storage/images/'.$menu->picture) }}" alt="" class="img-fluid picture-preview">
        ...
        <div class="col-12 col-md-8">
            <div class="app-card app-card-settings p-4">
                <div class="app-card-body">
                    ...
                    <a href="/admin/menu/" class="btn btn-danger text-white" role="button">Cancel</a>
                </div>
            </div>
        </div>
    </div>
