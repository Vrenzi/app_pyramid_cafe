                    ...
                    @foreach ($foods as $food)
                        <div class="col-6 col-md-4 col-xl-3 col-xxl-2 mb-4 mb-lg-0">
                            <div class="card rounded shadow-sm h-100 app-card-doc border-0 card-menu">
                                <div class="card-body p-4"><img src="{{ asset('storage/images/' . $food->picture) }}" alt="{{ asset('storage\app\public\images' . $food->picture) }}"
                                        ...
                                        <div class="app-card-actions">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="delete">
                                                        <form action="/admin/menu/{{ $food->id }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="dropdown-item border-0 bg-transparent"
                                                                onclick="return confirm('are you sure? '+{{ $food->id }})"><i
            ...
            <div class="tab-pane fade" id="drink">
                <div class="row g-4">
                    @foreach ($drinks as $drink)
                        <div class="col-6 col-md-4 col-xl-3 col-xxl-2 mb-4 mb-lg-0">
                            <div class="card rounded shadow-sm h-100 app-card-doc border-0 card-menu">
                                <div class="card-body p-4"><img src="{{ asset('storage/images/' . $drink->picture) }}" alt="                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           {{ asset('storage\app\public\images' . $drink->picture) }}"
                                    class="img-fluid d-block mx-auto mb-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="app-card-actions">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="delete">
                                                        <form action="/admin/menu/{{ $drink->id }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="dropdown-item border-0 bg-transparent"
