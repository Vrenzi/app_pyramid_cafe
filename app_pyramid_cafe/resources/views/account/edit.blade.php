...
@foreach($user as $key)
<div class="col-12 ">
    <form action="/admin/user/edit/{{ $key->id }}" method="POST" class="app-card app-card-account shadow-sm d-flex flex-column align-items-start" enctype="multipart/form-data">
        @csrf
        ...
        <div class="app-card-footer p-4 mt-auto">
            ...
            <a class="btn btn-danger text-white" href="/admin/user/{{ $key->id }}">Cancel</a>
        </div>
    </form>
</div>
<script>
