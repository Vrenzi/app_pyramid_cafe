...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validateddata = $request->validate([
            ...
            'without_spaces' => 'Username sudah terdaftar, gunakan yang lain',
        ...
        return redirect('/admin/user')->with('success', 'New employee has been added !');
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        ActivityLog::create($activity);
        return redirect('/admin/user')->with('success', 'employee has been updated !');
    }
