...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $menu->modal = trim($request->input('modal'));
        ...
        //$validateddata["picture"] = $request->file('image')->store('storage/images/menu');
    ...
    public function update(Request $request, Menu $menu)
    {
        ...
        if ($request->file('picture')) {
            ...
            $validateddata['picture'] = $request->file('picture')->store('storage/images/menu'); 
        }
    ...
    public function menu(Request $request, Menu $menu)
    {
        ...
        $menu = $menu->find($id);
        // $menu->diff = $menu->created_at->diffForHumans();;
        return view('Pyramid.menu', compact('menu'));
    }
